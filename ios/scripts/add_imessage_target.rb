...
#
# Wires the ImHimMessages iMessage-app extension target into
# ios/Runner.xcodeproj alongside the existing ImHimShare target.
# Idempotent — re-running is safe.
#
# DO NOT RUN this until the bundle id com.mirrorly.app.imessage is
# registered on the Apple Developer portal. Without that, the next CI
# build fails on signing the same way ImHimShare did before its
# bundle id was registered. Same 30-second portal step the user did
# before — just one more identifier.
...
# Same Xcode-15 cycle fix as the share installer.
target_index = 4
...
puts 'Make sure this is registered on the Apple Developer portal.'
