...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // blurbs "How we handle photos" + "How FirstMove works") are gone.
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ── Get FirstMove Pro — top of the list (red crown) ───────────
              if (!kBypassPaywall)
                _SettingTile(
                  icon: Icons.workspace_premium_rounded,
                  iconColor: AppColors.red,
                  title: 'Get FirstMove Pro',
                  onTap: () {
...
/// on the icon, FirstMove Inter typography.
///
