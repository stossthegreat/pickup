...
LegalDoc get termsDoc => LegalDoc(
  ...
  sections: [
    ...
    const LegalSection('VOICE & TRAINING DATA — EYES AND GAME TABS',
      ...
      'Phone → Mirrorly\'s AURALAY backend at '
      ...
      'AURALAY backend; only timestamps and HTTP status codes are '
      ...
      'token from the AURALAY backend (HTTPS) → phone opens a TLS-'
      ...
      'synthesis.\n'
      '• Mirrorly\'s AURALAY backend on Railway — transient routing '
      ...
      '• In flight: TLS 1.3 encrypted.\n'
      '• Mirrorly AURALAY backend: bytes not persisted; only HTTP '
...
LegalDoc get privacyDoc => LegalDoc(
  ...
  sections: [
    ...
    const LegalSection('THE SHORT VERSION',
      ...
      'sent (over TLS) to our AURALAY backend, forwarded in-memory '
    ...
    const LegalSection('VOICE & TRAINING DATA — EYES AND GAME TABS',
      ...
      'OpenAI Realtime API token from the AURALAY backend (HTTPS) '
      ...
      'not stored.\n'
      '• In flight: TLS 1.3 encrypted.\n'
      '• AURALAY backend: bytes not persisted; only status + '
