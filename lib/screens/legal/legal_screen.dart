...
LegalDoc get termsDoc => LegalDoc(
  ...
  sections: [
    ...
    LegalSection('IMHIM PRO — WHAT YOU GET, PRICE & AUTO-RENEWAL',
      ...
      '• Unlimited live AI voice roleplay with every character.\n'
    ...
    LegalSection('SUBSCRIPTIONS & AUTO-RENEWAL',
      ...
      'This subscription unlocks every ImHim Pro feature — unlimited AI '
      'voice and text roleplay, unlimited rizz coaching, and all '
