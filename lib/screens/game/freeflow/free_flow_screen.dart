...
class _FreeFlowScreenState extends State<FreeFlowScreen>
  ...
  Widget _buildLive() {
    ...
    // Bro v6 b: "the FirstMove on roleplay should only show when the
    ...
    return Stack(
      children: [
        ...
        // chrome layout: FirstMove wordmark on the left, controls on
        ...
        // ── FirstMove wordmark overlay (the "viral back-and-forth" CTA).
        // Bro v5: "add FirstMove header on the live roleplay but only when
        ...
        // FirstMove wordmark moved INTO the top chrome row above (when
        ...
        // room for the FirstMove wordmark that now sits directly above it.
