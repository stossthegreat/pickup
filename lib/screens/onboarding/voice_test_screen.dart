...
class _VoiceTestScreenState extends State<VoiceTestScreen>
  ...
  Future<void> _start() async {
    ...
    if (!_live) {
      // STRAIGHT TO THE PRICE. There was an explanatory dialog here for
      // trial users — "voice is a paid feature, it unlocks when you are
      // charged". With no trial there is no such state and no need to
      // explain anything: he has not paid, so the answer to reaching
      // for the microphone is the paywall, which says what it costs.
      // ignore: discarded_futures
